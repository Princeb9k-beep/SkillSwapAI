...
export const api = {
  ...
  endorse: (id, skill) => request(`/users/${id}/endorse`, { method: "POST", body: { skill } }),
  myCertificates: () => request("/certificates"),
  verifyCertificate: (code) => request(`/certificates/verify/${code}`, { auth: false }),
  ...
  inviteBuddy: (partner_id) => request("/buddies", { method: "POST", body: { partner_id } }),
  acceptBuddy: (id) => request(`/buddies/${id}/accept`, { method: "POST" }),
  buddyCheckin: (id) => request(`/buddies/${id}/checkin`, { method: "POST" }),
  endBuddy: (id) => request(`/buddies/${id}/end`, { method: "POST" }),
